export default function AboutPage() {
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-1/4 w-[800px] h-[800px] bg-rose-200/40 dark:bg-red-600/10 rounded-full blur-[150px] pointer-events-none mix-blend-screen"></div>
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <div className="text-xl md:text-2xl text-slate-700 dark:text-rose-100/80 leading-relaxed font-medium max-w-4xl mx-auto mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left text-slate-600 dark:text-rose-100/70 leading-relaxed">
            <p className="bg-white dark:bg-white/5 p-8 rounded-3xl border border-slate-200 dark:border-white/10 backdrop-blur-md">
          ...
          <div className="mt-8 bg-gradient-to-r from-rose-50 to-white dark:from-rose-950/80 dark:to-[#24050b]/80 p-8 rounded-3xl border border-rose-200 backdrop-blur-md text-center max-w-3xl mx-auto shadow-sm">
            <p className="text-slate-600 dark:text-rose-100/70 leading-relaxed">
              Through structured design methodologies such as <strong className="text-slate-900 dark:text-white">Design Sprints</strong> and the <strong className="text-slate-900 dark:text-white">Double Diamond framework</strong>, the program guides participants through problem discovery, solution design, and potential real-world implementation. By leveraging IEEE’s global network, SDG Sprints 2026 aims to create an ecosystem where humanitarian technology innovation can thrive.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <div className="relative p-10 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-md group hover:border-rose-400/50 transition-colors">
            ...
            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Project Vision</h3>
            <p className="text-slate-600 dark:text-rose-100/70 leading-relaxed text-lg">
          ...
          <div className="relative p-10 rounded-3xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-md group hover:border-pink-400/50 transition-colors">
            ...
            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Project Mission</h3>
            <p className="text-slate-600 dark:text-rose-100/70 leading-relaxed text-lg">
        ...
        <div className="mb-24 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-12">Core Values</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center">
            ...
            {[
              ...
              <div key={idx} className={`bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-8 backdrop-blur-sm hover:-translate-y-2 transition-transform duration-300 hover:bg-slate-50 dark:hover:bg-white/10 dark:bg-[#24050b] ${idx > 2 ? 'md:col-span-1 md:col-start-2 lg:col-span-1' : ''}`}>
                <div className="w-14 h-14 mx-auto bg-gradient-to-br from-rose-400 to-pink-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-rose-500/20 text-slate-900 dark:text-white">
                ...
                <p className="text-slate-600 dark:text-rose-100/70 text-sm leading-relaxed">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-10 text-center">Objectives & Goals</h3>
          <div className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-md">
              ...
              {[
                ...
                <li key={index} className="flex items-start gap-4 group">
                  <div className="mt-1 w-8 h-8 rounded-full bg-rose-500/20 border border-rose-500/40 flex items-center justify-center flex-shrink-0 group-hover:bg-rose-500/40 transition-colors">
                    <span className="text-rose-600 dark:text-rose-400 font-bold text-sm">{index + 1}</span>
                  </div>
                  <p className="text-slate-600 dark:text-rose-100/70 text-lg leading-relaxed pt-0.5 group-hover:text-slate-900 dark:text-white transition-colors">
                    {goal}
                  </p>
                </li>
              ))}
